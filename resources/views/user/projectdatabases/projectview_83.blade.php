                                    ...
                                    <thead class="bg-blue-950 text-white">
                                        <tr class="h-8 text-xs">
                                            ...
                                            <th class="sticky top-0 border px-1 w-[140px]" style="background-color: green">
                                                Estimated
                                                Material Cost</th>
                                            <th class="sticky top-0 border px-1 w-[160px]" style="background-color: green">
                                                Estimated Transportation Cost</th>
                                            <th class="sticky top-0 border px-1 w-[140px]" style="background-color: green">
                                                Estimated Other Cost</th>
                                            ...
                                            <th class="sticky top-0 border px-1 w-[100px] bg-sky-500 text-white">Swap Code</th>
                                            <th class="sticky top-0 border px-1 w-[100px] bg-sky-500 text-white">Tower Audit
                                                Date (Plan)</th>
                                            <th class="sticky top-0 border px-1 w-[100px] bg-sky-500 text-white">Tower Audit
                                                Date (Actual)</th>
                                            <th class="sticky top-0 border px-1 w-[100px] bg-sky-500 text-white">Go / Nogo</th>
                                            <th class="sticky top-0 border px-1 w-[100px] bg-sky-500 text-white">Audit Cal
                                                Date</th>
                                            <th class="sticky top-0 border px-1 w-[100px] bg-sky-500 text-white">Cal Lot</th>
                                            ...
                                            <th class="sticky top-0 border px-1 w-[100px] bg-sky-500 text-white">Material -
                                                Actual Price</th>
                                            <th class="sticky top-0 border px-1 w-[100px] bg-sky-500 text-white">Retrofit
                                                Date (Plan)</th>
                                            <th class="sticky top-0 border px-1 w-[100px] bg-sky-500 text-white">Retrofit
                                                Date (Actual)</th>
                                            <th class="sticky top-0 border px-1 w-[100px] bg-sky-500 text-white">Tower Group
                                            </th>
                                            <th class="sticky top-0 border px-1 w-[100px] bg-sky-500 text-white">Tower Type
                                            </th>
