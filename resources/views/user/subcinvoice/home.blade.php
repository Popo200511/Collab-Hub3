    ...
    <main class="flex-1 p-6 bg-gray-100 overflow-y-auto">
        ...
        <div class="bg-white p-4 rounded-md mb-6 shadow-md">
            ...
            <form action="{{ route('billing.home') }}" method="POST" enctype="multipart/form-data"
                ...
                <input type="file" name="file" id="small-file-input" accept=".xlsx" required class="block w-[400px] border border-gray-200 shadow-sm rounded-lg text-sm 
                   focus:z-10 focus:border-blue-500 focus:ring-blue-500 
                   disabled:opacity-50 disabled:pointer-events-none 
                   file:bg-gray-50 file:border-0 file:me-4 file:py-2 file:px-4">

                <!-- ปุ่มเช็คข้อมูล -->
                <button type="submit" class="bg-indigo-500 text-white text-sm px-4 py-2 rounded-md 
