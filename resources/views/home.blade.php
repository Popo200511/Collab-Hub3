        ...
        <div class="flex-1 flex flex-col overflow-hidden main-content-area">
                ...
                <header class="bg-white shadow-lg z-10 sticky top-0 px-6 md:px-8 py-4 border-b border-gray-200">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="flex items-center space-x-3">
                            <img src="https://www.akerufeed.com/wp-content/uploads/2022/09/men-hair-cut.jpeg" alt="Avatar"
                            ...
                            <div class="flex items-center space-x-3">
                                <div x-data="{ open: false }" class="relative inline-block text-left">
                                    ...
                                    <button @click="open = !open" type="button"
                                        class="flex items-center bg-gray-900 text-white text-sm font-medium px-4 py-2 rounded-xl">

                                        <div class="relative mr-2.5">
                                            <i
                                                class="fa-solid fa-bell text-base
            {{ $unreadCount > 0 ? 'text-red-500' : 'text-gray-400' }}"></i>
                                    ...
                                    <div x-show="open" @click.outside="open = false"
                                        ...
                                        <div
                                            ...
                                            <!--<button class="text-indigo-600 text-sm font-medium hover:underline">ดูทั้งหมด</button> -->
                                        </div>

                                        {{-- ตัวกรอง (Filter Tabs) --}}
                                        <div class="px-4 py-2 flex gap-2 bg-white">
                                            <span
                                                class="px-3 py-1 bg-indigo-50 text-indigo-600 rounded-full text-xs font-bold cursor-pointer">ทั้งหมด
                                            </span>
                                        ...
                                        <div class="max-h-[450px] overflow-y-auto">
                                            ...
                                            @forelse ($unreadNotifications as $item)
                                                <a href="{{ route('notification.read', $item->id) }}"
                                                    class="group flex gap-3 px-4 py-3 bg-white hover:bg-gray-100 border-b transition">

                                                    <img src="https://ui-avatars.com/api/?name={{ $item->Requester }}"
                                                    ...
                                                    <div class="flex-1">
                                                        ...
                                                        <span class="text-xs text-blue-600 font-medium">
                                                            {{ Auth::user()->status === 'Admin'
                                                                ? \Carbon\Carbon::parse($item->created_at)->timezone('Asia/Bangkok')->diffForHumans()
                                                                : \Carbon\Carbon::parse($item->updated_at)->timezone('Asia/Bangkok')->diffForHumans() }}
                                                        </span>
                                                    </div>

                                                    <span class="mt-2 w-2.5 h-2.5 bg-blue-600 rounded-full"></span>
                                                </a>
                                            @empty
                                            ...
                                            @if ($readNotifications->count())
                                                <div class="px-4 py-2 text-xs font-semibold text-gray-400 bg-gray-50">
                                                    ก่อนหน้านี้
                                                </div>

                                                @foreach ($readNotifications as $item)
                                                    <div class="flex gap-3 px-4 py-3 bg-gray-50 border-b opacity-70">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto px-6 md:px-8 pt-6 pb-4 md:pb-6 bg-gray-100">
                ...
                <div class="flex space-x-4 mb-6 text-sm font-semibold border-b border-gray-300">
                    ...
                    <a href="#"
                        class="pb-2 border-b-2 border-transparent text-gray-500 hover:text-indigo-600">Budget</a>
                    <a href="#"
                        class="pb-2 border-b-2 border-transparent text-gray-500 hover:text-indigo-600">Team</a>
                </div>
