    ...
    <div class="flex h-[calc(100vh-64px)] overflow-hidden">
        ...
        <main class="flex-1 p-6 bg-gray-100 overflow-y-auto">
            ...
            <div class="bg-white p-4 rounded-md mb-6 shadow-md">
                <h1 class="text-2xl font-bold text-blue-900 mb-4">Import File WO</h1>
            ...
            <div class="bg-white p-4 rounded-md shadow-md h-[450px]">
                <h2 class="text-2xl font-bold mb-4 text-blue-900">WO Records</h2>
                <table class="min-w-full border-collapse">
                    <thead class="bg-blue-100 sticky top-0">
                        <tr>
                            <th class="py-2 px-4 border-b">PR/MR No.</th>
                            <th class="py-2 px-4 border-b">Date</th>
                            <th class="py-2 px-4 border-b">Delivery Date</th>
                            <th class="py-2 px-4 border-b">Ref code</th>
                        </tr>
                    </thead>
                </table>
